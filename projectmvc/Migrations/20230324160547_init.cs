        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceafterProfit = table.Column<double>(type: "float", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSizeColor_Color_ProductColorID",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ProductSizeColor_Size_ProductSizeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Cart_ProductSizeColor_ProductID",
                        column: x => x.ProductID,
                        principalTable: "ProductSizeColor",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_OrderItems_ProductSizeColor_ProductID",
                        column: x => x.ProductID,
                        principalTable: "ProductSizeColor",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSizeColor_ProductColorID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSizeColor_ProductSizeID",
                table: "ProductSizeColor",
